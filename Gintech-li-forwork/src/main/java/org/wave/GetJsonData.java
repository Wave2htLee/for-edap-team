                ...
                if (!start) {
                    ...
                    if (c == '"') {
                        if (!isStringChar) {
                            ...
                            if (symbol[checkIndex] == c) {
                                isStringChar = false;
                                checkIndex--;
                            } else {
                                System.out.println(i + " ： 索引位置");
